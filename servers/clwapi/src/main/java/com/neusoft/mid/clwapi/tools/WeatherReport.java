...
import com.neusoft.mid.clwapi.entity.homePage.WeatherInfo;
...
public class WeatherReport {
	...
	public static WeatherInfoResp getWeatherInfo(String region) {
		...
		try {
			...
			weatherTime.setTime(weatherTime.getTime()
					+ Integer.parseInt(HttpConstant.WEATHER_VALID_TIME) * 1000);
			logger.debug("下次气象更新时间："
					+ TimeUtil.formatDateToString(weatherTime,
							HttpConstant.WEATHER_TIME_FORMAT));
