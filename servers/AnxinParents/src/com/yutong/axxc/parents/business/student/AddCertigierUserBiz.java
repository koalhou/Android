...
import com.yutong.axxc.parents.connect.http.packet.AddCertigierUserReq;
import com.yutong.axxc.parents.connect.http.packet.AddCertigierUserRes;
 ...
 *
 */
public class AddCertigierUserBiz extends YtAsyncTask {
    ...
    public AddCertigierUserBiz(Context context, Handler handler, String usr_id, String cld_id) {
        this.context = context;
        this.handler = handler;
        this.usr_id = usr_id;
        this.cld_id = cld_id;
        logTypeName = "[添加授权用户信息逻辑类]:";
    }
    ...
    private void handleProcess() {
        ...
        AddCertigierUserReq req = buildReq();
    ...
    private void parseAndProcessRes(HttpRes httpRes) {
        AddCertigierUserRes res = new AddCertigierUserRes();
    ...
    private AddCertigierUserReq buildReq() {
        AddCertigierUserReq req = new AddCertigierUserReq();
