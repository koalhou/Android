...
public class Converter {
    ...
    protected NeuGeoPoint wgtochina_lb(int wg_lng, int wg_lat, int wg_heit, int wg_week, int wg_time) {
        double x_add;
        double y_add;
        double h_add;
        double x_l;
...
//        }
     ...
     * @return
     */
    public NeuGeoPoint getEncryPoint(double x, double y) {
        NeuGeoPoint point = new NeuGeoPoint();
        double x1, tempx;
        double y1, tempy;
        x1 = x * 3686400.0;
        y1 = y * 3686400.0;
        ...
        point = me.wgtochina_lb((int) (x1), (int) (y1), (int) (gpsHeight), (int) (gpsWeek), (int) (gpsWeekTime));
        tempx = point.getX();
        tempy = point.getY();
