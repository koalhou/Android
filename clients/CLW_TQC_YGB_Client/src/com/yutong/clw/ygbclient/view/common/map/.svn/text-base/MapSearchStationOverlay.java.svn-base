 ...
 * 
 */
public class MapSearchStationOverlay {
	...
	public MapSearchStationOverlay(Context context, MapView view, Drawable editicon,
			Drawable editicon_checked) {
		
		biz = new BizOutOfFactory(context);
		...
		mData = new HashMap<String, MapSearchStationOverlay.StationItem>();
	...
	public MapSearchStationOverlay(Context context, MapView view) {
	...
	private void showRemindView(final StationItem item) {
		...
		final ImageView favouriteStar = (ImageView) popEidtView
