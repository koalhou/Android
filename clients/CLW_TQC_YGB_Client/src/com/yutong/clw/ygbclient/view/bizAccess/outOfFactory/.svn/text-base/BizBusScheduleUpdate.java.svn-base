...
public class BizBusScheduleUpdate extends BizBase {

	public BizBusScheduleUpdate(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public BizBusScheduleUpdate(Context context, int threadcount) {
...
//	 * @param process
//	 */
//	public void getRealTimeVehicheData(final List<String> station_ids,
