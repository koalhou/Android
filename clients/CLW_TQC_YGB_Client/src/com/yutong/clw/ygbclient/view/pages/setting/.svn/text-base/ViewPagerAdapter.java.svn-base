...
/**
 * @{# ViewPagerAdapter.java Create on 2013-5-2 下午11:03:39 class desc: 引导页面适配器
 *     <p>
...
public class ViewPagerAdapter extends PagerAdapter
{
    ...
    public ViewPagerAdapter(List<View> views, Activity activity, String returnType)
    {
        this.views = views;
    ...
    public Object instantiateItem(View arg0, int arg1)
    {
        ...
        try
        {
            ...
            {
                Button btn = (Button) (View) views.get(arg1).findViewById(R.id.btn_return);
                if (btn != null)
                {
