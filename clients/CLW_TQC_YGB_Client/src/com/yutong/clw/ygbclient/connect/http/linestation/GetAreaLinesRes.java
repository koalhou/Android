 ...
 * 获取厂区范围线路信息响应类
 * 
 * @author zhangzhia 2013-10-23 上午9:35:55
 * 
 */
public class GetAreaLinesRes extends AbstractRes
{
	/**
	 * 获取厂区范围线路信息
	 */
	...
	public boolean parseCorrectMsg(String jsonObject)
	{
		...
		{
			Logger.e(this.getClass(), "[获取厂区范围线路信息响应类]:解析 响应消息出错，详细信息：", e);
			return false;
		}
	}
