 ...
 * 获取推荐站点列表信息响应类
 * 
 * @author zhangzhia 2013-10-23 上午9:36:56
 * 
 */
public class RecommendStationsRes extends AbstractRes
{
	/**
	 * 站点信息集合
	 */
	...
	public boolean parseCorrectMsg(String jsonObject)
	{
		...
		{
			Logger.e(this.getClass(), "[获取推荐站点列表信息响应类]:解析 响应消息出错，详细信息：", e);
			return false;
		}
	}
