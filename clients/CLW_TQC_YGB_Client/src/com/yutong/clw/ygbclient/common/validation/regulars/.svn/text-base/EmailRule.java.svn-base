 ...
 */
public class EmailRule extends AbstractRegularRule
{
    private String regular;
    
    public EmailRule()
    {
        this.regular = String.format("^[0-9a-z][a-z0-9\\._-]{1,}@[a-z0-9-]{1,}[a-z0-9]\\.[a-z\\.]{1,}[a-z]$");

        this.faildesc = String.format("必须为邮箱格式");
    }
